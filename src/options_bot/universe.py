...
# Covers the most liquid, most optionable names across large/mid cap.
_FALLBACK_UNIVERSE = [
    # Mega-cap tech / most-traded options
    "AAPL", "MSFT", "NVDA", "AMZN", "GOOGL", "META", "TSLA",
    "AVGO", "ORCL", "NFLX", "AMD", "ADBE", "CRM", "QCOM",
    # Financials
    "JPM", "BAC", "GS", "MS", "V", "MA", "BRK-B", "WFC",
    # Healthcare
    "UNH", "JNJ", "PFE", "ABBV", "MRK", "LLY", "TMO",
    # Consumer
    "AMZN", "HD", "MCD", "COST", "NKE", "SBUX", "TGT",
    # Energy / Industrials
    "XOM", "CVX", "COP", "CAT", "BA", "HON", "GE",
    # ETFs (most liquid for index-level strategies)
    "SPY", "QQQ", "IWM", "GLD", "XLF", "XLK",
]
